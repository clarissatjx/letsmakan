...
function getDishImagePath(dishName) {
    const imageMap = {
        ...
        'Chilli Crab': 'img/chilli_crab.png', // hand draw
        'Rojak': 'img/rojak.png',
        'Laksa': 'img/laksa.png',
        ...
        'Oyster Omelette': 'img/oyster_omelette.png', // not done
        'Black Pepper Crab': 'img/black_pepper_crab.png', // hand draw
        'Murtabak': 'img/murtabak.png' // not done // generated
    };
